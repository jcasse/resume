...
\newcommand{\headerinfo}{
    ...
    ($contact.phone.area-code$) $contact.phone.number$ \hfill
...
$for(experience-sections)$
    ...
    $for(experience-sections.companies)$
        ...
        % http://mirrors.ibiblio.org/CTAN/macros/latex/contrib/enumitem
        %     /enumitem.pdf
        %\rule[-32\baselineskip]{2pt}{32\baselineskip}
        \begin{myitemize}[leftmargin=\parindent,align=left,labelwidth=\parindent,labelsep=0pt]
            ...
            $for(experience-sections.companies.jobs)$
                ...
                \begin{itemize}[nosep, leftmargin=\parindent,align=left,labelwidth=\parindent,labelsep=0pt]
                  \setlength\topsep{0pt}
